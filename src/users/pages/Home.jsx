...
const getHomeBooks = async ()=>{
  ...
  return (
    <div>
      ...
      {/* landing */}
      <div >
        <div style={{ height: "500px" }} className="flex h-screen flex-col justify-center items-center bg-[url(./homebgimage.jpg)] bg-cover bg-center text-white">
          <div style={{ height: "500px", backgroundColor: "rgba(0,0,0,0.5)" }} className='w-full flex flex-col justify-center items-center'>
            ...
            <div className='mt-9 relative'>
              <input type="text" onChange={e=>setSearchKey(e.target.value)} className='bg-white text-gray-500 p-2 rounded-full w-100 focus:outline-0 ' placeholder='Search Books' />
              <button
